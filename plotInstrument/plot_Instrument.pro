PRO BuildGui, GROUP_LEADER=wGroup, _EXTRA=_VWBExtra
...
pro plot_Instrument, GROUP_LEADER=wGroup, _EXTRA=_VWBExtra
  BuildGui, GROUP_LEADER=wGroup, _EXTRA=_VWBExtrai
end
