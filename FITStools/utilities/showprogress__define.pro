...
FUNCTION ShowProgress::Init, $
  ...
  ENDIF ELSE BEGIN
    ...
    main_base_geometry = WIDGET_INFO(parent,/GEOMETRY)
    main_base_xoffset = main_base_geometry.xoffset
    main_base_yoffset = main_base_geometry.yoffset
    main_base_xsize = main_base_geometry.xsize
    main_base_ysize = main_base_geometry.ysize
    
    xoffset = (self.xsize + main_base_xsize)/2 + main_base_xoffset
    yoffset = (self.ysize + main_base_ysize)/2 + main_base_yoffset
    
    self.tlb = Widget_Base(Group_Leader=parent, $
      xoffset = xoffset, $
      yoffset = yoffset, $
      Modal=modal, $
      Title=self.title, $
  ...
  ;Widget_Control, self.tlb, XOffset = xlocation, $
  ;  YOffset = ylocation
...
FUNCTION UpdateProgressBar, CNstruct, progressBar
  ...
  phase          = CNStruct.phase + 1
  CNStruct.phase = phase
  percentDone    = phase/CNstruct.nbrPhase
  cancelled      = progressBar->CheckCancel()
