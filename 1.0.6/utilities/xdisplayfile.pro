; $Id: //depot/idl/IDL_70/idldir/lib/utilities/xdisplayfile.pro#1 $
;
  ...
  CASE retval OF
    ...
    "SAVE_AS": BEGIN
      ...
      IF (STRLEN(state.filename) GT 0) THEN BEGIN
        ...
        ;put new name of file into main base
        main_event = state.event
        id = WIDGET_INFO(main_event.top, FIND_BY_UNAME='es_file_name')
        WIDGET_CONTROL, id, SET_VALUE=state.filename
