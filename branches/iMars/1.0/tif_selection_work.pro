...
pro tif_selection_work
  ...
  if (bCheckSelection) then begin
    ...
    if (bAverageValue) then begin
      average_value=[52605.41288,$
        52816.03077,$
        52649.5731,$
        52770.59897,$
        52701.69072,$
    ...
    for i=0,(n_elements(list_file)-1) do begin
      ...
      histoplot, data, histdata=histdata,$
        xrange=[40000,65000],$
        yrange=[0,65000],$
        locations=locations
      ...
      if (bAverageValue) then begin
        ...
        myPlot = plot(locations, $
          histdata,$
          ;      /ylog,$
          xrange=[30000,60000],$
          yrange=[0,50000],$
          color='red')
        average = plot([x0,x0,x0,x0,x0],[y0,y1,y1,y0,y0],/continue,/overplot)
      endif
