...
pro rfio6,ndummy,nsp,tau,x,y,n,name,e,dunkel=dunkel
; Liest einen Spektra FIO file. ndummy DUmmyzeilen werden "uberlesen
;if name lt 10 then name=string(name,format='(i1)')
;if name lt 100 and name ge 10 then name=string(name,format='(i2)')
;if name ge 100 then name=string(name,format='(i3)')
;name='/tmp/neuefein/leer_tt'+name+'.fio'
