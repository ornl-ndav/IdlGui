...
list_of_files_folders="SANScalibration miniSANScalibration sans_calibration.sav mini_sans_calibration.sav README install_SANScalibration images drversion SANScalibration.cfg"
