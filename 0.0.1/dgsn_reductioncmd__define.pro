...
PRO DGSN_ReductionCmd::Cleanup
  PTR_FREE, self.extra
END

PRO DGSN_ReductionCmd::GetProperty, $
...
PRO DGSN_ReductionCmd::SetProperty, $
    Program=program, $                   ; Program name
    Version=version, $
    Queue=queue, $                       ; Queue name
    Verbose=verbose, $                   ; Verbose flag
...
function DGSN_ReductionCmd::Generate
...
function DGSN_ReductionCmd::Init, $
    Program=program, $                   ; Program name
    Version=version, $
...
;+
; :Description:
;    DGSN_ReductionCmd Define.
;
; :Author: scu
;-
pro DGSN_ReductionCmd__Define

  struct = { DGS_REDUCTIONCMD, $
