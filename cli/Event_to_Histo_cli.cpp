  ...
  try
    {
      ...
      ValueArg<int32_t> neutronArg("l","linear",
                                   "size of linear time bin",
                                   true, -1, "linear time bin", cmd);
      
      ValueArg<string> mapArg("f", "event", "Name of the event file", 
