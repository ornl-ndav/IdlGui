...
Resolve_Routine, 'bss_rebin_nexus_eventcb',/COMPILE_FULL_FILE  ; Load event callback routines
...
combine_results = get_up_to_date_map_geo_tran_files ('BSS')
...
;
pro bss_rebin_nexus, GROUP_LEADER=wGroup, _EXTRA=_VWBExtra_
