...
// Calculate the final histogram array
void produce_data_histo_log(binary_type * BinaryArray,
                            const vector<float> & time_bin_array,
                            binary_type * data_histo,
                            const int GlobalArraySize);
                         ...
                         vector<float> & time_bin_array)
{
  ...
  switch(type_of_rebining)
    ...
    case 'd':
      ...
      break;
    case 'L':
      produce_data_histo_log(BinaryArray,
                             time_bin_array,
                             data_histo,
                             GlobalArraySize);
