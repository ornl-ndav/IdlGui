...
;------------------------------------------------------------------------------
pro xroi__GrowSelectedROI, pState, STDDEV=stddev
...
;part of row about type of selection (inside or outside)
    ...
    wInsideSelectionButton = $
      WIDGET_BUTTON(wSelectionBase,$
                    ...
                    VALUE='SANScalibration_images/inside_circle_button.bmp',$
                    /BITMAP,$
    ...
    wOutsideSelectionButton = $
      WIDGET_BUTTON(wSelectionBase,$
                    ...
                    VALUE='SANScalibration_images/outside_circle_button.bmp',$
                    /BITMAP,$
...
;SAVE ROI FILE
    void = WIDGET_BUTTON( $
                          wToolbarBase, $
                          VALUE='SANScalibration_images/save.bmp',$
                          /BITMAP, $
...
;ROI FILE INFO
    void = WIDGET_BUTTON( $
                          wToolbarBase, $
                          VALUE='SANScalibration_images/prop.bmp',$
                          /BITMAP, $
...
;         )
            ...
            case STRUPCASE(_tools[i]) of
                'TRANSLATE-SCALE': begin
                    wTransScale = WIDGET_BUTTON( $
                        ...
                        VALUE='SANScalibration_images/arrow.bmp',$
                        /BITMAP, $
                ...
                'RECTANGLE': begin
                    wRectangle = WIDGET_BUTTON( $
                        wExcToolbarBase, $
                        VALUE='SANScalibration_images/rectangl.bmp',$
                        /BITMAP, $
                ...
                'RECTANGLE_EMPTY': begin
                    wRectangle = $
                      WIDGET_BUTTON( $
                                     wExcToolbarBase, $
                                     VALUE='SANScalibration_images/rectangle_empty.bmp',$
                                     /BITMAP, $
                                     TOOLTIP='Draw Rectangle ROIs', $
                ...
                'ELLIPSE': begin
                    wEllipse = WIDGET_BUTTON( $
                        wExcToolbarBase, $
                        VALUE='SANScalibration_images/ellipse.bmp',$
                        /BITMAP, $
                ...
                'ELLIPSE_EMPTY': begin
                    wEllipse = $
                      WIDGET_BUTTON( $
                                     wExcToolbarBase, $
                                     VALUE='SANScalibration_images/ellipse_empty.bmp',$
                                     /BITMAP, $
                                     TOOLTIP='Draw Ellipse ROIs', $
                ...
                'FREEHAND DRAW': begin
                    wFreePoly = WIDGET_BUTTON( $
                        wExcToolbarBase, $
                        VALUE='SANScalibration_images/freepoly.bmp',$
                        /BITMAP, $
                ...
                'FREEHAND DRAW EMPTY': begin
                    wFreePoly = WIDGET_BUTTON( $
                        wExcToolbarBase, $
                        VALUE='SANScalibration_images/freepoly_empty.bmp',$
                        /BITMAP, $
                        TOOLTIP='Draw Freehand ROIs', $
                ...
                'POLYGON DRAW': begin
                    wSegPoly = WIDGET_BUTTON($
                        wExcToolbarBase, $
                        VALUE='SANScalibration_images/segpoly.bmp',$
                        /BITMAP, $
                ...
                'POLYGON DRAW EMPTY': begin
                    wSegPoly = WIDGET_BUTTON($
                        wExcToolbarBase, $
                        VALUE='SANScalibration_images/segpoly_empty.bmp',$
                        /BITMAP, $
                        TOOLTIP='Draw Polygon ROIs', $
                ...
                'SELECTION': begin
                    wPick = WIDGET_BUTTON( $
                        wExcToolbarBase, $
                        VALUE='SANScalibration_images/select.bmp',$
                        /BITMAP, $
                        TOOLTIP='Select ROI', $
    ...
    void  = WIDGET_BUTTON( $
                           wToolbarBase, $
                           VALUE='SANScalibration_images/circle.bmp',$
                           /BITMAP, $
                           TOOLTIP='Select ROI', $
