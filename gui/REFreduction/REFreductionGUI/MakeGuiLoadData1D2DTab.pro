PRO MakeGuiLoadData1D2DTab, LOAD_DATA_BASE, D_DD_TabSize, D_DD_TabTitle
...
MakeGuiLoadData1DTab, load_data_D_DD_Tab, D_DD_TabSize, D_DD_TabTitle

;build Load_Data_2D tab
MakeGuiLoadData2DTab, load_data_D_DD_Tab, D_DD_TabSize, D_DD_TabTitle
